...
const About = () => {
  return (
    <>
      <div>
        <h2 className="text-SecondaryCol text-4xl font-bold text-center mb-6">À propos</h2>
      </div>
      <div className='flex justify-center items-center'>
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start space-y-8 md:space-y-0 md:space-x-10">
          ...
          <div className="md:w-1/2">
            <h3 className="text-2xl font-semibold text-SecondaryCol mb-4">C.A.M.A. (Compagnie Africaine pour la Modernisation de l'Agriculture)</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              <span className="font-semibold"><strong className='text-SecondaryCol'>Spécialisation :</strong></span> Production et vente de légumes et fruits. <br />
              <span className="font-semibold"><strong className='text-SecondaryCol'>Origine :</strong></span> Issue d'une réflexion collective entre étudiants agronomes et producteurs locaux. <br />
              <span className="font-semibold"><strong className='text-SecondaryCol'>Intervention :</strong></span> Toute la chaîne de production agricole.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              <span className="font-semibold"><strong className='text-SecondaryCol'>Mission :</strong></span> Assister les producteurs à mieux rentabiliser leur production grâce à la modernisation.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              <span className="font-semibold"><strong className='text-SecondaryCol'>Objectif :</strong></span> Inciter les jeunes à s'engager dans le domaine agricole.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              <span className="font-semibold"><strong className='text-SecondaryCol'>Services et Produits :</strong></span> Offrir les meilleurs services et produits agricoles pour améliorer la rentabilité et l'efficacité des producteurs.
            </p>
          </div>
